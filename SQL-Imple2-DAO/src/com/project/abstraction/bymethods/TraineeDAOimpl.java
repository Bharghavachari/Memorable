...
public class TraineeDAOimpl implements TraineeDAO{
	...
	public void insertData() {
		...
		String insertQuery = "insert into trainee value(3,'Just','m','java developer',8555012347, 'Bangalore',45000);";
	...
	public void updateData() {
		...
		String password = "Mysql@345";
		Connection connection = null;
		String updateQuery = "update trainee set designation = 'project developer' where id = 1";
